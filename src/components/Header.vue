<template>
  <div class="header">
    <div class="logo">
      <router-link :to="{name: 'deliveryDone'}">
...
<div class="time">
  Время доставки: {{estimateResult}}
</div>
    </div>
    <div class="info-link">
      <router-link :to="`/courier?hash=${this.$route.query.hash}`" class="el-button el-button--default el-button--small is-round">Информация о курьере
      </router-link>
    </div>
